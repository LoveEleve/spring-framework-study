 ...
 * 2. ConfigurationClassUtils.checkConfigurationClassCandidate():117 - 检查配置类类型
 * 3. ConfigurationClassParser.parse():181 - 解析阶段
 * 4. ConfigurationClassParser.processImports():794 - @Import处理
 * 5. ConfigurationClassParser.DeferredImportSelectorHandler.process():1051 - 延迟处理
 * 6. ConfigurationClassBeanDefinitionReader.loadBeanDefinitions():126 - 加载阶段
 */
@Configuration  // Full配置类，会被CGLIB代理
@ComponentScan(basePackages = "com.debug.simpleDemo_1.service")  // 立即扫描组件
@Import({
